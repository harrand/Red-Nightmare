rn.mods.basegame.levels.startscreen =
{
	on_load = function()
		...
		rn.data_store():set("player", player)
		...
		rn.data_store():edit_some("title_string", title_string, "title_string_author", title_string_author, "title_string_press_to_begin", title_string_press_to_begin)
	end,
	update = function(delta_seconds)
		local w, h = tz.window():get_dimensions()
		local ren = rn.renderer()
		local title_string, title_string_author, title_string_press_to_begin = rn.data_store():read_some("title_string", "title_string_author", "title_string_press_to_begin")
		...
		local player = rn.data_store():read("player")
