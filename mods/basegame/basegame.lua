...
require("basegame/items/imperial_plate_platelegs")
require("basegame/items/fiery_hauberk")
require("basegame/items/holy_water_sprinkler")
require("basegame/items/insin")
require("basegame/items/iron_chainlegs")
require("basegame/items/iron_chainmail")
require("basegame/items/iron_coif")
require("basegame/items/iron_mace")
require("basegame/items/iron_sallet")
