...
namespace rnlib
{
	namespace detail
	{
		box quadtree_helper::compute_quadrant_box(const box& parent_box, std::size_t quadrant_id)
		{
		...
		std::optional<std::size_t> quadtree_helper::find_quadrant_id(const box& node_box, const box& value_box)
		{
